...
Plap is built with latest development tools and design patterns.
- Written in Kotlin
- Android Architecture Components (Viewmodels, Livedata, Room)
- Databinding
- Dependency injection with KOIN

Plap works across all devices including
- Phones
- Android Wear
- Android Auto
...
Plap works with Google Assistant. Common voice commands that work with assistant are 

 - play music on plap
 - play 'song name' on plap
 - play 
 - pause
 - next song
 - previous song
