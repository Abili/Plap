...
import com.aisc.plap.constants.Constants.ACTION_RESTORE_MEDIA_SESSION
import com.aisc.plap.constants.Constants.NOW_PLAYING
import com.aisc.plap.databinding.LayoutBottomsheetControlsBinding
import com.aisc.plap.extensions.*
import com.aisc.plap.models.CastStatus
import com.aisc.plap.models.CastStatus.Companion.STATUS_PLAYING
import com.aisc.plap.network.models.ArtworkSize
import com.aisc.plap.ui.activities.MainActivity
import com.aisc.plap.ui.bindings.setLastFmAlbumImage
import com.aisc.plap.ui.bindings.setPlayState
    ...
    private fun setupCast() {
        ...
        val castStatusObserver = Observer<CastStatus> {
            ...
            if (it.isCasting) {
                ...
                mainViewModel.castProgressLiveData.observe(requireActivity(), castProgressObserver)
                setLastFmAlbumImage(
            ...
            .observe(this) {
                when (it) {
                    ACTION_CAST_CONNECTED -> {
                        mainViewModel.castLiveData.observe(requireActivity(), castStatusObserver)
                    }
