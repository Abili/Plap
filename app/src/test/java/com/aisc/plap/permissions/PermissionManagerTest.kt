 ...
 *
 */
package com.aisc.plap.permissions
...
import com.aisc.plap.Plap
import com.aisc.plap.permissions.RealPermissionsManager.Companion.REQUEST_CODE_STORAGE
...
@Config(manifest = Config.NONE, sdk = [28], application = Plap::class)
